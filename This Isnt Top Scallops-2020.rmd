...
```{r, out.width = "300px", fig.align="right", dpi = 36, out.extra='style="float:right; padding:10px"'}
add_image("Pics/Highlights/Wk5/Nancy.png", "300px")
```
...
2. Eric Adjepong ranks a very close second for his vocal appreciation of his wife’s bod (“Janelle walks in with her fine ass”), coupled with his very smooth choice to spend a sliver of his $600 Whole Foods budget on flowers. Looks like Eric’s keyed into his wife’s [love](https://www.5lovelanguages.com/languages/receiving-gifts/) [languages](https://www.5lovelanguages.com/languages/words-of-affirmation/). We are required to stan. 

3. Brian Malarkey unsurprisingly comes in dead last for the lifeless eyes of the woman who seems to be asking herself, every second of this episode, how she ended up in this situation (and by situation, I mean marriage). If we were still in the business of feeling sorry for the wife of a narcissistic psychopath (tbt 2017), we might call these “Melania Eyes.” Malarkey blames his wife for misstep in his dish and calls the experience a “fun marriage counseling session.” At least someone thinks they were having fun. Somehow Brian Malarkey is only the [second most unpleasant man in a fedora](https://findingmyrepublicangoddess.com/) I’ve been cursed with laying eyes on today.  
...
```{r, out.width = "125px", fig.align="left", dpi = 36}
add_image("Pics/Highlights/Wk5/Emma.jpg", "125px")
```
