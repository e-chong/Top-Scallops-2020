...
include_graphics("Pics/Highlights/Wk2/Chris-Katya Padma Shout-Out.jpg")
```
...
```{r, out.width = highlightsize, fig.align="center"}
include_graphics("Pics/Highlights/Wk2/Eugene-Janet Tom Instagram.jpg")
include_graphics("Pics/Highlights/Wk2/Eugene-Janet Tom Instagram2.jpg")
```

**Claire** made a delicious banana bread last week. And big ups to the mysterious goop in the red tupperware, the rhythm instrument to the bread's lead guitar. We see you, goop!

```{r, out.width = highlightsize, fig.align="center"}
include_graphics("Pics/Highlights/Wk2/Claire banana bread.jpeg")
```

For his homework, **Eugene** had to identify "ships" in some satellite images. That sure doesn't look like a ship!

```{r, out.width = highlightsize, fig.align="center"}
include_graphics("Pics/Highlights/Wk2/ships (allegedly).png")
```

**Sarah** made some awesome dumplings, but more importantly, check out the coaster. I fucking love projections.

```{r, out.width = highlightsize, fig.align="center"}
include_graphics("Pics/Highlights/Wk2/Sarah dumps.jpeg")
```
...
```{r, out.width = highlightsize, fig.align="center"}
include_graphics("Pics/Highlights/Wk2/Natasha Foccacia.jpeg")
```

Like all Asian men on Twitter, **Eugene** is trying to grow facial hair for the first time. Here's a ~15 day update. In the words of his good friend Milo:

```{r, out.width = highlightsize, fig.align="center"}
include_graphics("Pics/Highlights/Wk2/Milo Tweet.PNG")

include_graphics("Pics/Highlights/Wk2/Eugene face.jpg")
```
...
```{r, out.width = dishsize}
include_graphics("https://i.imgur.com/xhdo9r1.png")
```

```{r, out.width = dishsize}
include_graphics("https://i.imgur.com/AsTOpbQ.png")
```

```{r, out.width = dishsize}
include_graphics("https://i.imgur.com/wcqEGUH.png")
```

**Losing Dish**

```{r, out.width = dishsize}
include_graphics("https://i.imgur.com/9O9vxou.png")
```
